...
{
    public class SoilCardController : Controller
    {
        ...
        public SoilCardController(IConfiguration configuration, IHostingEnvironment hostingEnvironment)
        {
            _configuration = configuration;
            _hostingEnvironment = hostingEnvironment;
        }
        public IActionResult soilcard()
        {
            return View();
        }
        string urlstring = "";
        ...
        [HttpPost]
        public ActionResult getsoliparameters([FromBody] soilcardlist objContext)
        {
            soilParametersDetailItems obj_soilparalist = new soilParametersDetailItems();
            string Post_data = "";
            try
            {
                ...
                using (var client1 = new HttpClient())
                {
                    ...
                    {
                        string urlcon = "api/Kiosk_Soil_Card/";
                        client.BaseAddress = new Uri(urlstring + urlcon);
                        client.DefaultRequestHeaders.Accept.Clear();
                        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                        var response1 = client.GetAsync("getsoliparameters?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&lang=" + objContext.localeId + "&status=" + objContext.soil_status + "").Result;
                        ...
                        obj_soilparalist = (soilParametersDetailItems)JsonConvert.DeserializeObject(post_data, typeof(soilParametersDetailItems));
                    }
        ...
        [HttpPost]
        public ActionResult getNONNABLsoliparameters([FromBody] soilcardlist objContext)
        {
            soilParametersDetailItems obj_soilparalist = new soilParametersDetailItems();
            ...
            try
            {
                ...
                using (var client1 = new HttpClient())
                {
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                        var response1 = client.GetAsync("getNONNABLsoliparameters?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&lang=" + objContext.localeId + "&status=" + objContext.soil_status + "").Result;
                        Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                        StreamReader reader1 = new StreamReader(data1);
                        post_data = reader1.ReadToEnd();
                        obj_soilparalist = (soilParametersDetailItems)JsonConvert.DeserializeObject(post_data, typeof(soilParametersDetailItems));
        ...
        #endregion
        [HttpPost]
        public ActionResult SoilcardList([FromBody] soilcardlist objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    string Urlcon1 = "api/Kiosk_Soil_Card/";
                    client.BaseAddress = new Uri(urlstring + Urlcon1);
                    client.DefaultRequestHeaders.Accept.Clear();
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("SoilCardList??org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&lang=" + objContext.localeId + "&In_farmer_gid=" + objContext.In_farmer_gid + "&status=" + objContext.soil_status + "").Result; ;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
        ...
        [HttpPost]
        public ActionResult Soilcardfetch([FromBody] soilviewContext objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("SoilCardListView?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "&soil_gid=" + objContext.soil_gid + "").Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
        ...
        [HttpPost]
        public ActionResult Soilcardsave([FromBody] soilcardsave objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    var response1 = client.PostAsync("soilcardsave", content1).Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
                }
        ...
        //selva
        [HttpPost]
        public ActionResult SoilcardLastInsertid([FromBody] soilcardlist objContext)
        {
            soilcardsave objout = new soilcardsave();
            string post_data = "";
            if (_configuration.GetSection("AppSettings")["Environment"].ToString() == "DEV")
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    HttpContent content1 = new StringContent(JsonConvert.SerializeObject(objContext), UTF8Encoding.UTF8, "application/json");
                    var response1 = client.PostAsync("SoilCardLastInsertid", content1).Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
                }
        ...
        {
            logger.Debug("export pdf start - 437 line");
            if (_configuration.GetSection("AppSettings")["Environment"].ToString() == "DEV")
            {
                urlstring = _configuration.GetSection("Api_dev")["api_url"].ToString();
            }
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("SoilCardPrint?org=" + orgnId + "&locn=" + locnId + "&user=" + userId + "&lang=" + localeId + "&In_Tran_Id=" + In_Tran_Id + "&In_farmer_code=" + In_farmer_code + "").Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
                    ...
                    {                        
                        ...
                        logger.Debug("export pdf start PDFNAFLOGO crossed- 549 line");
                        iTextSharp.text.Image imagel = iTextSharp.text.Image.GetInstance(imageleft);
                        imagel.Alignment = (Element.ALIGN_LEFT);
                        imagel.WidthPercentage = 100;
                        PdfPCell cellimage = new PdfPCell();
                    ...
                    //Hcell1.BorderColorLeft = BaseColor.WHITE;
                    //Hcell1.BorderWidthLeft = 1f;
                    //Hcell1.BorderColorRight = BaseColor.WHITE;
                    ...
                    HeaderDetails.AddCell(new PdfPCell(new Phrase(objList.Print[0].farmer_samplereceived, NormalFont1)) { BackgroundColor = BaseColor.LIGHT_GRAY });
                    ...
                    HeaderDetails.AddCell(new PdfPCell(new Phrase("Pollution & Environment", grey1)) { BackgroundColor = BaseColor.LIGHT_GRAY });
                    ...
                    int[] HeaderDetailsCellWidth1 = { 15, 30, 15, 15, 40 };
                    ...
                    string[] arr = objList.Print[0].farmer_testmethod.ToString().Split(".");
                    string testmethod = "";
                    for(int i=0;i< arr.Length;i++)
                    {
                        testmethod = testmethod + arr[i].ToString() + "\n\n";
                    }
                    HeaderDetails1.AddCell(new PdfPCell(new Phrase(new Chunk((1).ToString(), NormalFont1))) { HorizontalAlignment = Element.ALIGN_CENTER });
                    HeaderDetails1.AddCell(new PdfPCell(new Phrase(objList.Print[0].parameter, NormalFont1)));
                    HeaderDetails1.AddCell(new PdfPCell(new Phrase(objList.Print[0].unit, NormalFont1)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    HeaderDetails1.AddCell(new PdfPCell(new Phrase(objList.Print[0].result, NormalFont1)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    HeaderDetails1.AddCell(new PdfPCell(new Phrase(testmethod, NormalFont3))).Rowspan = objList.Print.Count;

                    for (int rows = 1; rows < objList.Print.Count; rows++)
                    {
