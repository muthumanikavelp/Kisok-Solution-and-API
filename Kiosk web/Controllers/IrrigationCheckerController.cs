...
using static Kiosk_web.Models.IrrigationChecker_Modelcs;

namespace Kiosk_web.Controllers
{
    public class IrrigationCheckerController : Controller
    {
        public IActionResult IrrigationChecker()
        {
            return View();
        }

        log4net.ILog logger = log4net.LogManager.GetLogger(typeof(IrrigationCheckerController)); //Declaring Log4Net.
        private IHostingEnvironment _hostingEnvironment;
        private MySqlConnection con;
        string dbstring = "";
        private IConfiguration _configuration;
        dynamic excel_msg = new JObject();
        public IrrigationCheckerController(IConfiguration configuration, IHostingEnvironment hostingEnvironment)
        {
        ...
        [HttpPost]
        public ActionResult getirrigationparametersChecker([FromBody] irrigationlist objContext)
        {
            ...
            try
            {
                ...
                using (var client1 = new HttpClient())
                {
                    ...
                    {
                        string urlcon = "api/IrrigationChecker_/";
                        client.BaseAddress = new Uri(urlstring + urlcon);
                        client.DefaultRequestHeaders.Accept.Clear();
                        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                        var response1 = client.GetAsync("getirrigationparametersChecker?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&lang=" + objContext.localeId + "&status=" + objContext.irrigation_status + "").Result;
        ...
        [HttpPost]
        public ActionResult irrigationListChecker([FromBody] irrigationlist objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    string Urlcon1 = "api/IrrigationChecker_/";
                    client.BaseAddress = new Uri(urlstring + Urlcon1);
                    client.DefaultRequestHeaders.Accept.Clear();
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("IrrigationListChecker??org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&lang=" + objContext.localeId + "&status=" + objContext.irrigation_status + "").Result; ;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
        ...
        [HttpPost]
        public ActionResult irrigationsaveChecker([FromBody] irrigationsave objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    var response1 = client.PostAsync("irrigationsaveChecker", content1).Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
                }
        ...
        [HttpPost]
        public ActionResult irrigationfetchChecker([FromBody] irrigationviewContext objContext)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("IrrigationListViewChecker?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "&irrigation_gid=" + objContext.irrigation_gid + "").Result;
                    Stream data1 = response1.Content.ReadAsStreamAsync().Result;
                    StreamReader reader1 = new StreamReader(data1);
                    post_data = reader1.ReadToEnd();
        ...
        //            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
        //            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
        //            var response1 = client.GetAsync("Irrigationprinthecker?org=" + orgnId + "&locn=" + locnId + "&user=" + userId + "&lang=" + localeId + "&In_Tran_Id=" + In_Tran_Id + "&In_farmer_code=" + In_farmer_code + "").Result;
        ...
        public byte[] exportpdf(string path, string Signature_NameP, string Signature_ImPathP, string Headerpart, string Signature_DesgnP)
        {
            ...
            using (var client1 = new HttpClient())
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(auth);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    var response1 = client.GetAsync("IrrigationprintChecker?org=" + orgnId + "&locn=" + locnId + "&user=" + userId + "&lang=" + localeId + "&In_Tran_Id=" + In_Tran_Id + "&In_farmer_code=" + In_farmer_code + "").Result;
