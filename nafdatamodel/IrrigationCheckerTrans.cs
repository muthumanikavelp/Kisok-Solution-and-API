...
{
  public static class IrrigationCheckerTrans
    {
        public static List<irrigationDetailItems> TranslateirrigationparadetChecker(this MySqlDataReader reader1)
        {
            var list1 = new List<irrigationDetailItems>();
            while (reader1.Read())
            {
                list1.Add(TranslateAsUserirrigationdetailChecker(reader1, true));
            }
            return list1;
        }

        public static irrigationDetailItems TranslateAsUserirrigationdetailChecker(this MySqlDataReader reader1, bool isList = false)
        {
            if (!isList)
            {
                if (!reader1.HasRows)
        ...
        #region
        public static List<irrigationlist> TransirrigationListChecker(this MySqlDataReader reader)
        {
        ...
        public static irrigationlist TranslateAslistChecker(this MySqlDataReader reader2, bool isList = false)
        {
            if (!isList)
            {
                if (!reader2.HasRows)
        ...
        #region
        public static irrigationviewHeader TranslateAsirrigationListChecker(this MySqlDataReader reader)
        {
        ...
        public static List<irrigationviewDetailItems> TranslateAsirrigationdetChecker(this MySqlDataReader reader1)
        {
        ...
        public static irrigationviewHeader TranslateAsUserChecker(this MySqlDataReader reader, bool isList = false)
        {
            if (!isList)
            {
                if (!reader.HasRows)
        ...
        public static irrigationviewDetailItems TranslateAsUserdetailChecker(this MySqlDataReader reader1, bool isList = false)
        {
            if (!isList)
            {
                if (!reader1.HasRows)
        ...
        #region
        public static List<irrigationPrintList> TranslateAsirrigationdetprintChecker(this MySqlDataReader reader1)
        {
        ...
        public static irrigationPrintList TranslateAsUserdetailPrintChecker(this MySqlDataReader reader1, bool isList = false)
        {
            if (!isList)
            {
                if (!reader1.HasRows)
