...
namespace nafmodel
{
    public class Kiosk_Soil_Card_model
    {


        #region
        #region  Soilparameters grid value 
        public class soilParametersDetailItems
        {
            public List<soilDetailItems> ParametersDetailItems { get; set; }
        }
        public class soilDetailItems
        {
        ...
        public class soilviewHeader
        {
            ...
            public string In_mode_flag { get; set; }
            [DataMember(Name = "out_crop_confirm")]
            public string out_crop_confirm { get; set; }

            [DataMember(Name = "out_soil_confirm")]
            public string out_soil_confirm { get; set; }
        ...
        public class soilviewContext
        {
            ...
            [DataMember(Name = "farmer_address")]
        ...
        public class soilPrintList
        {
            ...
            // ramya added on 27 jul 22
            [DataMember(Name = "Discipline")]
            public string Discipline { get; set; }
            [DataMember(Name = "farmergroup")]
        ...
        public class soilcardsave
        {
            ...
            [DataMember(Name = "In_mode_flag")]
            public string In_mode_flag { get; set; }
            [DataMember(Name = "In_crop_confirm")]
