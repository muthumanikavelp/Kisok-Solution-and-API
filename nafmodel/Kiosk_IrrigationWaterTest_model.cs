...
namespace nafmodel
{
   public class Kiosk_IrrigationWaterTest_model
    {
        ...
        public class irrigationDetailItems
        {
            ...
            public string In_irrigation_TestMethod { get; set; } // ramya added on 06 aug 22
        ...
        public class irrigationviewDetailItems
        {
            ...
            public string In_irrigation_uom { get; set; }
            // ramya added
            [DataMember(Name = "In_irr_TestMethod")]
            public string In_irr_TestMethod { get; set; }
        ...
        public class kioskIrrigationPdfAndEmail
        {
